...
import { runCommanderMain } from "@sidetrack/core";
...
program
  .name("@sidetrack/code-sidetrack-static")
  .description("Emit a static HTML code + sidetrack browser page")
  .option("--source <path>", "Source file to display", defaultSource)
  .option("--markdown <path>", "SideTrack Markdown file", defaultMarkdown)
