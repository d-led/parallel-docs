 ...
 * immediately after `globalThis.parallelDocsMermaid` is assigned — before optional `mermaid.run`.
 ...
 */
export const PARALLEL_DOCS_MERMAID_MODULE_READY_EVENT = "parallel-docs-mermaid-module-ready";
