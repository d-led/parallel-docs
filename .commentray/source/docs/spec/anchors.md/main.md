# `docs/spec/anchors.md` — commentray

<!-- commentray:block id=anchors-grammar-design -->
...
**`lines:` is the simplest.** No source markers needed, just line numbers. But it breaks on renumbering — use it for stable files or when you're adding commentary to generated code that can't have markers.
