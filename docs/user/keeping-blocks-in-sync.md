...
| Command                                                                  | Purpose                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`parallel-docs init`**                                                 | Ensures dirs + `index.json`, creates `.parallel-docs.toml` if missing, runs migrations/normalization, merges **`d-led.parallel-docs`** into `.vscode/extensions.json` when that file is valid mergeable JSON, then **validate**. Safe to repeat.                                                                                                                  |
