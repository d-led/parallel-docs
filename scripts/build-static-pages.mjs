#!/usr/bin/env node
/**
 * Build `_site/index.html` for GitHub Pages from `.sidetrack.toml` `[static_site]`.
 * Implementation: {@link import("@sidetrack/code-sidetrack-static/github-pages-site")}.
 */
import path from "node:path";
import process from "node:process";
import { fileURLToPath } from "node:url";

import { buildGithubPagesStaticSite } from "@sidetrack/code-sidetrack-static/github-pages-site";
...
const pagesBuildCommitSha = process.env.SIDETRACK_PAGES_BUILD_SHA?.trim();
