# `buffering-flow-synchronizer.ts` — parallel-docs

<!-- #region parallelDocs:bfs-purpose -->
...
This file is intentionally **agnostic of ASCII grids**, golden filenames, and buffer “ink” symbols. Those belong to [`buffering-flow-synchronizer-approval-printer.ts`](https://github.com/d-led/parallel-docs/blob/main/packages/core/src/buffering-flow-synchronizer-approval-printer.ts) and the approval harness. DOM wiring is in [`packages/render/src/block-stretch-buffer-sync.ts`](https://github.com/d-led/parallel-docs/blob/main/packages/render/src/block-stretch-buffer-sync.ts) — see [its parallel-docs](../../render/src/block-stretch-buffer-sync.ts/main.md).
...
<!-- #endregion parallelDocs:bfs-purpose -->

---

<!-- #region parallelDocs:bfs-pipeline -->
...
<!-- #endregion parallelDocs:bfs-pipeline -->

---

<!-- #region parallelDocs:bfs-design -->
...
<!-- #endregion parallelDocs:bfs-design -->

---

<!-- #region parallelDocs:bfs-approval-grids -->

## Where approval tests and grids fit

Golden files under `packages/core/src/buffering-flow-synchronizer.approvals/` are **documentation and regression** for the combination: parse → synchronize → print. Scenario names (e.g. zig-zag vs missing first region) are described next to the harness in [buffering-flow-synchronizer.approval.test.ts parallel-docs](../buffering-flow-synchronizer.approval.test.ts/main.md). Grid merge rules and token meanings are in [buffering-flow-synchronizer-approval-printer.ts parallel-docs](../buffering-flow-synchronizer-approval-printer.ts/main.md).

<!-- #endregion parallelDocs:bfs-approval-grids -->

---

<!-- #region parallelDocs:bfs-toml-sketch -->

## Normative TOML sketch

The normative sketch for id **`toml-buffering-flow-sync`** lives in the [`.parallel-docs.toml` parallel-docs](../../../.parallel-docs.toml/main.md) (Markdown block paired with placeholder comments in [`.parallel-docs.toml`](https://github.com/d-led/parallel-docs/blob/main/.parallel-docs.toml)). That block points here for implementation detail.

<!-- #endregion parallelDocs:bfs-toml-sketch -->
