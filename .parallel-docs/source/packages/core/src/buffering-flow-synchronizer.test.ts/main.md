# `buffering-flow-synchronizer.test.ts` — parallel-docs

<!-- #region parallelDocs:bfu-role -->
...
For **ASCII grid** coverage and layout invariants, see [buffering-flow-synchronizer.approval.test.ts parallel-docs](../buffering-flow-synchronizer.approval.test.ts/main.md). For the core pipeline narrative, see [buffering-flow-synchronizer.ts parallel-docs](../buffering-flow-synchronizer.ts/main.md).

<!-- #endregion parallelDocs:bfu-role -->
